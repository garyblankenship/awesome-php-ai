...
<body class="bg-gray-950 text-gray-100 min-h-screen">
    ...
    <header class="border-b border-gray-800 bg-gray-900/50 backdrop-blur-sm sticky top-0 z-10">
        <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <a href="https://github.com/ghostwriter/awesome-php-ai"
               target="_blank"
    ...
    <footer class="border-t border-gray-800 mt-16 py-8 text-center text-gray-600 text-sm">
        <a href="https://github.com/ghostwriter/awesome-php-ai" target="_blank" class="hover:text-gray-400 transition-colors">
            awesome-php-ai
        </a>
