...
| [LLM Chain](https://github.com/php-llm/llm-chain)<br><br><img src="https://img.shields.io/github/stars/php-llm/llm-chain?style=for-the-badge" alt="GitHub Repo stars"> | Comprehensive PHP library for building LLM-powered applications. |
...
| Library | Description |
|---------|-------------|
| [Instructor PHP](https://github.com/cognesy/instructor-php)<br><br><img src="https://img.shields.io/github/stars/cognesy/instructor-php?style=for-the-badge" alt="GitHub Repo stars"> | Extract structured data from LLM outputs with type safety and validation. |
...
| Library | Description |
|---------|-------------|
| [Symfony AI Platform](https://github.com/symfony/ai-platform)<br><br><img src="https://img.shields.io/github/stars/symfony/ai-platform?style=for-the-badge" alt="GitHub Repo stars"> | Official PHP library for interacting with AI platform providers. |
| [Symfony AI Agent](https://github.com/symfony/ai-agent)<br><br><img src="https://img.shields.io/github/stars/symfony/ai-agent?style=for-the-badge" alt="GitHub Repo stars"> | Official PHP library for building agentic applications. |
| [Symfony AI Bundle](https://github.com/symfony/ai-bundle)<br><br><img src="https://img.shields.io/github/stars/symfony/ai-bundle?style=for-the-badge" alt="GitHub Repo stars"> | Official integration bundle for Symfony AI components. |
| [Symfony MCP SDK](https://github.com/symfony/mcp-sdk)<br><br><img src="https://img.shields.io/github/stars/symfony/mcp-sdk?style=for-the-badge" alt="GitHub Repo stars"> | Official Model Context Protocol SDK for Client and Server applications. |
